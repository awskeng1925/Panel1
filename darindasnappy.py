...
# ================= CONFIG =================
SESSION_ID = os.environ.get("SESSION_ID", "39581976351%3AgTCNTb8gCkU2cK%3A27%3AAYiHU6zgI6b9mOJkTOvLm_QBYNGl6Br0wrIrWDE-zg")
THREAD_ID = os.environ.get("THREAD_ID", "18091118003240787")
MAX_WORKERS = int(os.environ.get("MAX_WORKERS", "5"))
NAME_CHANGE_INTERVAL = 10
# ==========================================

# ===== LONG SPAM MESSAGES (Multi-Line) =====
LONG_MESSAGES = [
    """
...
🩸🩸🩸 PRVR/DHRUV/OSKE TATTE TMKC ON TOP 🩸🩸🩸
🖤🖤🖤 PRVR/DHRUV/OSKE TATTE TMKC ON TOP 🖤🖤🖤
☠️☠️☠️ PRVR/DHRUV/OSKE TATTE TMKC ON TOP ☠️☠️☠️
🕷️🕷️🕷️ PRVR/DHRUV/OSKE TATTE TMKC ON TOP 🕷️🕷️🕷️
""",
    """
████████████████████████████████████████████████████████████
...
# ===== GROUP NAMES (Long) =====
GROUP_NAMES = [
    "PRVR/DHRUV/OSKE TATTE TMKC 🔥",
    "PRVR/DHRUV/OSKE TATTE TMKC 💀",
    "PRVR/DHRUV/OSKE TATTE TMKC ⚡",
    "PRVR/DHRUV/OSKE TATTE TMKC 🩸",
    "PRVR/DHRUV/OSKE TATTE TMKC 🖤",
    "PRVR/DHRUV/OSKE TATTE TMKC ☠️",
    "PRVR/DHRUV/OSKE TATTE TMKC 🕷️",
    "PRVR/DHRUV/OSKE TATTE TMKC 😈",
    "PRVR/DHRUV/OSKE TATTE TMKC 💥",
    "PRVR/DHRUV/OSKE TATTE TMKC 🧃",
...
class SpamWorker:
    ...
    def login(self):
        try:
            ...
            csrf = SESSION_ID.split('%')[0] if '%' in SESSION_ID else SESSION_ID[:8]
            self.driver.add_cookie({
                "name": "csrftoken",
                "value": csrf,
                "domain": ".instagram.com",
    ...
    def send_message(self, msg):
        try:
            # Split long message into lines and send
...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=port)def clean_session_id(session_id):
